...
def test_buffer_endpoint_creates_buffered_result(client):
    # Prepare payload
    payload = {
        'messages': [{ "type": "human", "content": "buffer the points by 100 meters of layer with id=layer1" }],   
        "options": {},
...
def test_chat_buffer_line_expected_result(client, stub_requests):
    line = {
        ...
        "features": [
        { "type": "Feature", "properties": { "id": 1, "name": "Unter den Linden Boulevard" }, "geometry": { "type": "LineString", "coordinates": [ [ 13.3778, 52.5163 ], [ 13.39, 52.517 ], [ 13.4, 52.518 ] ] } }
        ]
    }
    ...
    output_line = {
        ...
        "crs": { "type": "name", "properties": { "name": "urn:ogc:def:crs:OGC:1.3:CRS84" } },
        "features": [
        { "type": "Feature", "properties": { "id": 1, "name": "Unter den Linden Boulevard 500m Buffer" }, "geometry": { "type": "Polygon", "coordinates": [ [ [ 13.389424328846832, 52.519712249946679 ], [ 13.399271653204945, 52.520696921764923 ], [ 13.399709585028491, 52.520727375039968 ], [ 13.40015031370697, 52.520731563006969 ], [ 13.400589594782282, 52.520709445341005 ], [ 13.401023197737533, 52.520661235007864 ], [ 13.401446946739235, 52.52058739621453 ], [ 13.401856760852858, 52.520488639941938 ], [ 13.402248693344458, 52.520365917102659 ], [ 13.402618969689891, 52.520220409389466 ], [ 13.402964023925538, 52.520053517902447 ], [ 13.403280532990477, 52.519866849664083 ], [ 13.403565448729399, 52.519662202151686 ], [ 13.403816027247984, 52.519441545995974 ], [ 13.404029855338118, 52.519207006011875 ], [ 13.404204873718401, 52.518960840744072 ], [ 13.404339396866161, 52.518705420723734 ], [ 13.404432129249942, 52.518443205645802 ], [ 13.4044821778062, 52.518176720686114 ], [ 13.404489060539975, 52.51790853218634 ], [ 13.40445271116678, 52.517641222940838 ], [ 13.40437347975095, 52.517377367323249 ], [ 13.40425212933433, 52.517119506492229 ], [ 13.40408982858777, 52.516870123915588 ], [ 13.403888140556184, 52.516631621448155 ], [ 13.403649007605566, 52.516406296194361 ], [ 13.403374732716957, 52.516196318378285 ], [ 13.403067957307465, 52.516003710434873 ], [ 13.402731635791991, 52.51583032752378 ], [ 13.402369007130572, 52.515677839653918 ], [ 13.401983563635456, 52.515547715591325 ], [ 13.401579017338204, 52.515441208705433 ], [ 13.401159264240807, 52.515359344890705 ], [ 13.400728346795052, 52.5153029126799 ], [ 13.390728346795052, 52.514302851294701 ], [ 13.390421630915364, 52.514278743766518 ], [ 13.378221630915364, 52.513578700413305 ], [ 13.377781293178932, 52.513566654071688 ], [ 13.377341135599414, 52.513580932160338 ], [ 13.376905397134914, 52.513621397147915 ], [ 13.376478274185047, 52.513687659262921 ], [ 13.376063880177304, 52.51377908025006 ], [ 13.375666205952514, 52.513894779521486 ], [ 13.375289081330852, 52.514033642643177 ], [ 13.374936138228584, 52.514194332074787 ], [ 13.374610775680717, 52.514375300059029 ], [ 13.374316127106454, 52.514574803536291 ], [ 13.374055030132633, 52.514790920940385 ], [ 13.373829999265846, 52.515021570713529 ], [ 13.37364320167635, 52.515264531361595 ], [ 13.373496436327049, 52.515517462856536 ], [ 13.373391116648484, 52.51577792917908 ], [ 13.373328256926737, 52.516043421784815 ], [ 13.373308462535288, 52.516311383767061 ], [ 13.373331924104948, 52.516579234483928 ], [ 13.373398415687976, 52.51684439441209 ], [ 13.373507296934079, 52.517104309988085 ], [ 13.373657519257341, 52.517356478197691 ], [ 13.373847635934661, 52.517598470677008 ], [ 13.374075816038513, 52.517827957092933 ], [ 13.374339862069759, 52.51804272757839 ], [ 13.374637231120781, 52.518240714006438 ], [ 13.374965059365053, 52.518420009898534 ], [ 13.375320189637373, 52.518578888775849 ], [ 13.37569920183909, 52.51871582077699 ], [ 13.37609844587551, 52.518829487382625 ], [ 13.376514076808313, 52.518918794105417 ], [ 13.376942091884407, 52.518982881023504 ], [ 13.377378369084637, 52.519021131056192 ], [ 13.389424328846832, 52.519712249946679 ] ] ] } }
        ]
    }
    stub_requests({"line.geojson": line})

    payload = {
        "messages": [{"type":"human","content":"buffer the line by 500 meters of geodata_layers with id=layer2"}],
        "options": {},
...
def test_chat_overlay_intersection_expected_area(client, stub_requests):
    ...
    path_inter_greenland = os.path.join(os.path.dirname(__file__), 'testdata', 'intersection_greenland_aoi.json')
    ...
    payload = {
        "messages": [{"type":"human","content":"do the operation overlay with how=intersection and crs=EPSG:3413 on both layers with id=layer3 and id=layer4, both layers are already available in your state"}],
        "options": {},
