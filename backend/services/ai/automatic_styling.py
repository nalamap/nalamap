...
FEATURE_KEYWORDS = {
    "water": [
        "water", "waters", "hydro", "hydrography", "aqua", "marine", "sea", "ocean", "bay", "gulf", "strait",
        "lake", "lakes", "pond", "ponds", "reservoir", "reservoirs", "lagoon", "lagoons"
    ],
    "river": [
        "river", "rivers", "stream", "streams", "creek", "creeks", "brook", "brooks", "tributary", "tributaries",
        "waterway", "waterways", "drainage", "basin", "basins", "catchment"
    ],
    "forest": [
        "forest", "forests", "woodland", "woodlands", "trees", "tree", "timber", "jungle", "rainforest"
    ],
    "vegetation": [
        "vegetation", "green", "grass", "grassland", "meadow", "meadows", "pasture", "rangeland", "shrub", "shrubs"
    ],
    "park": [
        "park", "parks", "garden", "gardens", "recreation", "protected", "conservation", "reserve", "reserves",
        "wildlife", "nature", "sanctuary", "national_park"
    ],
    "urban": [
        "urban", "city", "cities", "town", "towns", "metropolitan", "settlement", "settlements", "residential",
        "commercial", "industrial", "developed", "development"
    ],
    "building": [
        "building", "buildings", "structure", "structures", "construction", "facility", "facilities",
        "infrastructure_building", "house", "houses", "office", "offices"
    ],
    "road": [
        "road", "roads", "highway", "highways", "street", "streets", "avenue", "route", "routes", "motorway",
        "freeway", "boulevard", "lane", "path", "paths"
    ],
    "transport": [
        "transport", "transportation", "traffic", "railway", "railroad", "rail", "metro", "subway", "transit",
        "airport", "port", "harbor", "station", "terminal"
    ],
    "agriculture": [
        "agriculture", "agricultural", "farm", "farms", "farming", "crop", "crops", "field", "fields",
        "cultivation", "livestock", "ranch", "pasture"
    ],
    "boundary": [
        "boundary", "boundaries", "border", "borders", "limit", "limits", "demarcation", "division",
        "administrative_boundary", "political"
    ],
    "administrative": [
        "administrative", "admin", "district", "districts", "region", "regions", "state", "states",
        "province", "provinces", "county", "counties", "municipality", "municipalities"
    ],
    "elevation": [
        "elevation", "dem", "dtm", "topography", "topographic", "contour", "contours", "height", "altitude",
        "terrain", "relief", "slope", "hill", "hills", "mountain", "mountains"
    ],
    "infrastructure": [
        "infrastructure", "utility", "utilities", "pipeline", "pipelines", "cable", "cables", "line", "lines",
        "grid", "network", "system", "telecommunications", "communication"
    ],
    "energy": [
        "energy", "power", "electric", "electrical", "transmission", "distribution", "substation", "substations"
    ],
    "power": [
        "power_line", "powerline", "transmission_line", "electrical_grid", "power_grid"
    ]
}
...
def generate_automatic_style(layer_name: str, layer_description: str = None, 
                           geometry_type: str = None) -> LayerStyle:
    """
