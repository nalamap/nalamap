AMENITY_MAPPING = {
    ...
    "railways": "railway=*",
    "rail": "railway=*",
    # Generic highway/road/infrastructure queries (wildcard - matches all highway types)
    "highway": "highway=*",
    "highways": "highway=*",
    "road": "highway=*",
    "roads": "highway=*",
    ...
    "route": "highway=*",
    "routes": "highway=*",
    # Generic military queries (wildcard - matches all military types)
    "military": "military=*",
    "defense": "military=*",
    "defence": "military=*",
    ...
    # Generic aeroway queries (wildcard - matches all aeroway types)
    "aeroway": "aeroway=*",
    "aviation": "aeroway=*",
