...
DEFAULT_SYSTEM_PROMPT: str = (
    ...
    " - Inputs: Country name(s) or ISO code(s); indicator name or World Bank code; "
    "optional year range.\n"
    ...
    " - Inputs: Location (coordinates or place name); date range or 'forecast'; "
    "optional variables (temperature, precipitation, wind, etc.).\n"
    ...
    " - Inputs: Bounding box or place name; date range (up to 10 days for NRT); "
    "optional satellite source (VIIRS/MODIS).\n"
    ...
    " - Overlap policy: Use nasa_fire_data for analytical fire-point data; use "
    "nasa_gibs_layer (Fires & Thermal category) for a visual satellite tile overlay.\n\n"
    ...
    "Call this before nasa_gibs_layer when the user has not specified a layer name.\n"
    "- nasa_gibs_layer\n"
    ...
    " - Inputs: Layer name or natural-language description; optional date.\n"
    ...
    " - Overlap policy: Prefer nasa_gibs_layer for visual satellite context; use "
    "nasa_fire_data for analytical fire-point layers.\n\n"
